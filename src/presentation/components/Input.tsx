        ...
        <>
            <div className="mt-4 mb-2" tabIndex={1}
                ...
                <div className="flex justify-center items-center space-x-4 ">
                    <div
                        className={focus ? " ring-green-300 ring-green-300 ring-1 bg-white w-full border rounded-md px-4 py-3 shadow-sm  sm:text-sm flex justify-center items-center" : "  bg-white w-full border border-slate-300 rounded-md px-4 py-3 shadow-sm  sm:text-sm flex justify-center items-center"}
                    >   
                        <input
